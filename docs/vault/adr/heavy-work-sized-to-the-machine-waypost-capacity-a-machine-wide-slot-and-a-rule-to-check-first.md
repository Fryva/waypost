...
code_refs: ["scripts/capacity.mjs (planned)", "bin/waypost", "scripts/agents.mjs", "scripts/presence.mjs", "AGENTS.md", "package.json", "prompts/heavy.md (planned)", "tests/capacity.test.mjs (planned)", "tests/harness.test.mjs"]
