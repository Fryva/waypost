...
code_refs: ["scripts/capacity.mjs", "bin/waypost", "scripts/agents.mjs", "scripts/presence.mjs", "AGENTS.md", "package.json", "prompts/heavy.md (planned)", "tests/capacity.test.mjs", "tests/harness.test.mjs"]
