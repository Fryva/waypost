...
generated_at: 2026-09-15T03:12:56.755Z
...
| [[epics/WP-18/epic\|WP-18]] | Heavy work sized to the machine | planned | `scripts/capacity.mjs (planned)`, `scripts/lib.mjs`, `scripts/presence.mjs`, `scripts/agents.mjs`, `bin/waypost`, `AGENTS.md`, `package.json`, `prompts/heavy.md (planned)`, `tests/capacity.test.mjs (planned)`, `tests/harness.test.mjs`, `README.md`, `CHANGELOG.md` |
...
| WP-18 | Capacity verified on Linux and Windows virtual machines | `scripts/capacity.mjs (planned)`, `bin/waypost` |
...
| WP-18 | waypost capacity: the machine's real free resources, measured by each OS | `scripts/capacity.mjs (planned)`, `scripts/lib.mjs`, `bin/waypost`, `tests/capacity.test.mjs (planned)` |
| WP-18 | waypost run --heavy: a machine-wide slot for heavy work | `bin/waypost`, `scripts/capacity.mjs (planned)`, `scripts/presence.mjs`, `tests/capacity.test.mjs (planned)` |
